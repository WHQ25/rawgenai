...
<span aceTableMode="list" aceTableWidth="2,5,4"></span>
|场景 |输入 |输出 |
|---|---|---|
|有声视频生成|<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/46ecf776adf14c9aaf842ac7b06ee924~tplv-goo7wpa0wc-image.image =280x) </span>|<video src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/2400b351c4514dae897c197dcc963364~tplv-goo7wpa0wc-image.image" controls></video>|\
|> 仅 Seedance 1.5 pro 支持|> 一辆地铁轰隆隆驶过，书页和女孩的头发飞扬，镜头开始环绕着女孩360度旋转，周围的背景从地铁站渐渐转变为一个中世纪的教堂，西式幻想风格的音乐渐入。夹在女孩书中的几页信纸随风飞扬，在女孩的周身打着旋，随风而动的纸张降落时，女孩身处的环境已经彻底变成中世纪教堂的模样 | |\
|> 输出音画一体的高质量视频，支持环境音、动作音、合成音、乐器音、背景音乐及人声等。 | | |
|^^|<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/4f5b7b92a26e43e4a91ff9d1d677f57f~tplv-goo7wpa0wc-image.image =280x) </span>|<video src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/bb543334842a4ffb9265f25e4633d1fb~tplv-goo7wpa0wc-image.image" controls></video>|\
| |> 镜头围绕人物推镜头拉近，特写人物面部，她正在用京剧唱腔唱“月移花影，疑是玉人来”，唱词充满情感，唱腔充满传统京剧特有的韵味与技巧，完美体现了花旦角色的内心世界 | |
|多参考图生视频|<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/2a0691e5748e414c9a91837684d459d3~tplv-goo7wpa0wc-image.image =280x) </span>|<video src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/5717a47092d84faca866c6b3e0ce73f7~tplv-goo7wpa0wc-image.image" controls></video>|\
|> 支持上传多张参考图片，模型将依据这些图片的特征和风格，生成与之匹配的动态视频画面。 |> [图1]戴着眼镜穿着蓝色T恤的男生和[图2]的柯基小狗，坐在[图3]的草坪上，视频卡通风格 | |
|首尾帧生视频|<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/f8fc1008f23a4908b7c897e8b7eb87df~tplv-goo7wpa0wc-image.image =280x) </span>|<video src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/ace519a8a6d24c2c9ab3ccab1f729240~tplv-goo7wpa0wc-image.image" controls></video>|\
|> 根据输入的首尾关键帧，智能生成过渡画面，形成连贯流畅的视频内容。 |> 360度环绕运镜 | |
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="CwlFcoQ2hp"><RenderMd content={`\`\`\`Bash
...
<Tabs.TabPane title="Python" key="GIZYFnbW5D"><RenderMd content={`\`\`\`Python
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="HuQ7wJDq54"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="jKD9IEjBKW"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="AcLJsHeTqv"><RenderMd content={`\`\`\`Bash
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="FzjT18fokI"><RenderMd content={`\`\`\`Python
import os
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="sOBhkh4Shh"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="p0b4LrT7JY"><RenderMd content={`\`\`\`Go
package main
...
<span aceTableMode="list" aceTableWidth="4,3,3,3,3"></span>
|**模型 ID（Model ID）**  |**模型能力** |**输出视频格式** |**限流**|**免费额度**|\
| | | |**default: 在线推理**| **（token）**  |\
| | | |**flex: 离线推理** | |
|---|---|---|---|---|
|[doubao-seedance-1-5-pro-251215](https://console.volcengine.com/ark/region:ark+cn-beijing/model/detail?Id=doubao-seedance-1-5-pro)`音画同生` |支持有声视频|分辨率:|default:|default: 200万|\
| |图生视频\-首尾帧|480p, 720p, 1080p||flex: 无 |\
| |图生视频\-首帧|帧率: 24 fps|* RPM 600| |\
| |文生视频 |时长: 4~12 秒|* 并发数 10| |\
| | |视频格式: mp4 || |\
| | | |flex:| |\
| | | || |\
| | | |* TPD 5000亿 | |
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="qza0x7sJet"><RenderMd content={`\`\`\`Python
import os
import time  
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="r2HIlLACNS"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="SKQxJx0rbb"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="jSEVE9JCe8"><RenderMd content={`\`\`\`Python
import os
import time  
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="tEV1TeVlLQ"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="zUdrPpCEjG"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="rAxqZDE57S"><RenderMd content={`\`\`\`Python
import os
import time  
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="MZkER2jqwd"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="j5rfr8XZU1"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="O2ozYKW0ri"><RenderMd content={`\`\`\`Python
import os
import time  
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="nwK39PJ4Fs"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="bI4TywWNF2"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="hxPxJouJDv"><RenderMd content={`\`\`\`Bash
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="Lh4aAglveE"><RenderMd content={`\`\`\`Python
import os
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="WgLN3Z7UIE"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="UbalVE1YBF"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="OWs3ot7am2"><RenderMd content={`\`\`\`Bash
# Replace cgt-2025**** with the ID acquired from "Create Video Generation Task".
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="XToOUcfylK"><RenderMd content={`\`\`\`Python
import os
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="KK2sFPxW95"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="Xt7tes9bzq"><RenderMd content={`\`\`\`Go
package main
...
|生成视频时长（秒） | | | |
|frames|<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/96a134db51ea4e8d83b5c9dccff686c3~tplv-goo7wpa0wc-image.image =25x) </span> |支持 [29, 289] 区间内所有满足 25 + 4n 格式的整数值，其中 n 为正整数。 |支持 [29, 289] 区间内所有满足 25 + 4n 格式的整数值，其中 n 为正整数。 |\
|生成视频帧数 | | | |
|seed|<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/aba4522e4aab46318574c8c3e460d20b~tplv-goo7wpa0wc-image.image =20x) </span> |<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/aba4522e4aab46318574c8c3e460d20b~tplv-goo7wpa0wc-image.image =20x) </span> |<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/aba4522e4aab46318574c8c3e460d20b~tplv-goo7wpa0wc-image.image =20x) </span> |\
|种子整数 | | | |
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="jK7OOWMPzk"><RenderMd content={`\`\`\`Python
import os
import time  
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="OQEBZ98FS4"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="AMCzfumJn8"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="HpXtmZFPSu"><RenderMd content={`1. 创建 Draft 视频生成任务。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="bjn58u7Go8"><RenderMd content={`1. 创建 Draft 视频任务并轮询任务状态；
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="msxZhEw0KQ"><RenderMd content={`1. 创建 Draft 视频任务并轮询任务状态；
2. 当任务状态变为 \`succeeded\`后，您可在 content.**video_url** 字段处，下载生成的 Draft 视频文件，检视效果是否符合预期。若不符合预期，可重新调整参数并再次创建 Draft 视频生成任务。当确认 Draft 视频效果符合预期后，即可按照后续步骤生成最终视频。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="w2kcvEr2u0"><RenderMd content={`1. 创建 Draft 视频任务并轮询任务状态；
2. 当任务状态变为 \`succeeded\`后，您可在 content.**video_url** 字段处，下载生成的 Draft 视频文件，检视效果是否符合预期。若不符合预期，可重新调整参数并再次创建 Draft 视频生成任务。当确认 Draft 视频效果符合预期后，即可按照后续步骤生成最终视频。
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="hgksF3yRo3"><RenderMd content={`1. 基于 \`content.draft_task.id\` 创建视频生成任务。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="ZEYOPpXv8B"><RenderMd content={`1. 基于\`content.draft_task.id\` (此 ID 通过 Step1 的返回信息获取）创建视频生成任务并轮询获取任务状态；
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="ID1seJodRb"><RenderMd content={`1. 基于\`content.draft_task.id\` (此 ID 通过 Step1 的返回信息获取）创建视频生成任务并轮询获取任务状态；
2. 当任务状态变为 \`succeeded\` 后，您可在 content.**video_url** 字段处，下载生成的视频文件。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="Tduy8MKvie"><RenderMd content={`1. 基于\`content.draft_task.id\` (此 ID 通过 Step1 的返回信息获取）创建视频生成任务并轮询获取任务状态；
2. 当任务状态变为 \`succeeded\` 后，您可在 content.**video_url** 字段处，下载生成的视频文件。
